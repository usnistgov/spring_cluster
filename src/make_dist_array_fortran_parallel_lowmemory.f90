  subroutine make_dist_array_fortran_parallel_lowmemory(coords_super, other_coords, Acell_super, dist_array_min,&
...
!$OMP DO
    do a = 1,natsuper1
       dist_array_dist_min(a) = 100000000000000.0
       do b = 1,natsuper
          dmin = 10000000000.0
          do x =-1,2
             xyz(1) = x
...
!$OMP END PARALLEL
 ...
 end subroutine make_dist_array_fortran_parallel_lowmemory
