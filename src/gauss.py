...
#this implents gauss elimination in pure python. it was too slow, so I made pyx and f90 verions
#based on code from thirdorder, part of the ShengBTE package
