...
#      A,types,pos,forces,stress,energy = load_output(line.strip('\n').strip())
      ...
      if SP[0][0] == '#': #this finds comment lines
        print 'Skipping ' + line
        continue
...
#      print
  ...
  def load_harmonic_new(self,filename, asr=True,zero=True,stringinput=False):
    ...
    self.dyn.load_harmonic(filename, asr, zero, stringinput=stringinput)
